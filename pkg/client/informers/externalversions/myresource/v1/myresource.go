...
import (
	...
	myresourcev1 "github.com/caesarshift/k8s-controller-core-resource/pkg/apis/myresource/v1"
	versioned "github.com/caesarshift/k8s-controller-core-resource/pkg/client/clientset/versioned"
	internalinterfaces "github.com/caesarshift/k8s-controller-core-resource/pkg/client/informers/externalversions/internalinterfaces"
	v1 "github.com/caesarshift/k8s-controller-core-resource/pkg/client/listers/myresource/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.JonksmithV1().MyResources(namespace).List(options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.JonksmithV1().MyResources(namespace).Watch(options)
			},
		},
