...
import (
	...
	scheme "github.com/caesarshift/k8s-controller-core-resource/pkg/client/clientset/versioned/scheme"
...
func newMyResources(c *JonksmithV1Client, namespace string) *myResources {
	return &myResources{
		client: c.RESTClient(),
		ns:     namespace,
	}
