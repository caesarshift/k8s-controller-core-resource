...
ROOT_PACKAGE="github.com/caesarshift/k8s-controller-core-resource"
...
"$GOPATH/pkg/mod/k8s.io/code-generator@v0.17.0/generate-groups.sh" all "$ROOT_PACKAGE/pkg/client" "$ROOT_PACKAGE/pkg/apis" "$CUSTOM_RESOURCE_NAME:$CUSTOM_RESOURCE_VERSION"

# view the newly generated files
# find $GOPATH/src/$ROOT_PACKAGE/pkg/client
# pkg/client/
# ├── clientset
# │   └── versioned
# │       ├── clientset.go
